...
As an admin/faculty user, I should not be able to admit a student with an already existing admission number. 
  ...
  Scenario: CTSMS - Student unique admission number
    ...
    And enters "0123456" to Admission No text box
    And enters "12345" to Roll Number text box
    ...
    Then user gets an error message "The Admission No field must contain a unique value."
